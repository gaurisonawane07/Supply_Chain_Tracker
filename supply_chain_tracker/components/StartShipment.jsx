            ...
            <form>
              ...
              <div className="relative mt-3">
                <input
                  ...
                  placeholder="Id"
                  className="w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent
                  outline-none border focus:border-indigo-500 shadow-sm rounded-lg"
                  onChange={(e) =>
                    setGetProduct({
                      ...getProduct,
              ...
              <button
                ...
                text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2"
              >
                Get details
              </button>
            </form>
